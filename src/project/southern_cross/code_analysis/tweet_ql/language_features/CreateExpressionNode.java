 ...
 */
public class CreateExpressionNode extends SyntaxNode{
    public CreateExpressionNode(SyntaxNode parent, String rawString, int spanStart, int spanEnd, int fullSpanStart, int fullSpanEnd, int kind, boolean isMissing) {
