 ...
 */
public class WhereExpressionNode extends SyntaxNode {
    public WhereExpressionNode(SyntaxNode parent, String rawString, int spanStart, int spanEnd, int fullSpanStart, int fullSpanEnd, int kind, boolean isMissing) {
