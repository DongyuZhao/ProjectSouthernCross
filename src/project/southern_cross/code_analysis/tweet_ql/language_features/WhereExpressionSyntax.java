...
public class WhereExpressionSyntax extends SyntaxNode {
    public WhereExpressionSyntax(SyntaxNode parent, String rawString, int spanStart, int spanEnd, int fullSpanStart, int fullSpanEnd, int kind, boolean isMissing) {
