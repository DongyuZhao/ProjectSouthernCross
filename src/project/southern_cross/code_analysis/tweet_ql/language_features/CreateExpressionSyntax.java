...
public class CreateExpressionSyntax extends SyntaxNode{
    public CreateExpressionSyntax(SyntaxNode parent, String rawString, int spanStart, int spanEnd, int fullSpanStart, int fullSpanEnd, int kind, boolean isMissing) {
