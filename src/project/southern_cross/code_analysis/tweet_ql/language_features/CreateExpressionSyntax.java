...
public class CreateExpressionSyntax extends SyntaxNode{
    public CreateExpressionSyntax(SyntaxNode parent,  int spanStart, int spanEnd, int fullSpanStart, int fullSpanEnd, int kind, boolean isMissing, boolean isUnexpected, boolean withError) {
