...
public class FromExpressionSyntax extends SyntaxNode {
    public FromExpressionSyntax(SyntaxNode parent,  int spanStart, int spanEnd, int fullSpanStart, int fullSpanEnd, int kind, boolean isMissing, boolean isUnexpected, boolean withError) {
