...
public class StarToken extends SyntaxToken {
    ...
    public StarToken(int start, int end, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.STAR, TweetQlSyntaxTokenKind.STAR_TOKEN, start, end, missing, unexpected);
    }

    public StarToken(int start, int end, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.STAR, TweetQlSyntaxTokenKind.STAR_TOKEN, start, end, fullEnd, missing, unexpected);
    }

    public StarToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.STAR, TweetQlSyntaxTokenKind.STAR_TOKEN, start, end, fullStart, fullEnd, missing, unexpected);
    }
    ...
    public StarToken(int start, int end, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.STAR, TweetQlSyntaxTokenKind.STAR_TOKEN, start, end, missing, unexpected, parent);
    }

    public StarToken(int start, int end, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.STAR, TweetQlSyntaxTokenKind.STAR_TOKEN, start, end, fullEnd, missing, unexpected, parent);
    }

    public StarToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.STAR, TweetQlSyntaxTokenKind.STAR_TOKEN, start, end, fullStart, fullEnd, missing, unexpected, parent);
    }
}
