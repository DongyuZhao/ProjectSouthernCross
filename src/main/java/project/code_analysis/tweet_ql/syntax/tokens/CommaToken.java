...
public class CommaToken extends SyntaxToken {
    ...
    public CommaToken(int start, int end, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.COMMA, TweetQlSyntaxTokenKind.COMMA_TOKEN, start, end, missing, unexpected);
    }

    public CommaToken(int start, int end, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.COMMA, TweetQlSyntaxTokenKind.COMMA_TOKEN, start, end, fullEnd, missing, unexpected);
    }

    public CommaToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.COMMA, TweetQlSyntaxTokenKind.COMMA_TOKEN, start, end, fullStart, fullEnd, missing, unexpected);
    }
    ...
    public CommaToken(int start, int end, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.COMMA, TweetQlSyntaxTokenKind.COMMA_TOKEN, start, end, missing, unexpected, parent);
    }

    public CommaToken(int start, int end, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.COMMA, TweetQlSyntaxTokenKind.COMMA_TOKEN, start, end, fullEnd, missing, unexpected, parent);
    }

    public CommaToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.COMMA, TweetQlSyntaxTokenKind.COMMA_TOKEN, start, end, fullStart, fullEnd, missing, unexpected, parent);
    }
}
