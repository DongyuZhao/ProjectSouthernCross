...
public class LFToken extends SyntaxToken {
    ...
    public LFToken( int start, int end, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.LF, TweetQlSyntaxTokenKind.LF_TOKEN, start, end, missing, unexpected);
    }

    public LFToken( int start, int end, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.LF, TweetQlSyntaxTokenKind.LF_TOKEN, start, end, fullEnd, missing, unexpected);
    }

    public LFToken( int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.LF, TweetQlSyntaxTokenKind.LF_TOKEN, start, end, fullStart, fullEnd, missing, unexpected);
    }
    ...
    public LFToken( int start, int end, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.LF, TweetQlSyntaxTokenKind.LF_TOKEN, start, end, missing, unexpected, parent);
    }

    public LFToken( int start, int end, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.LF, TweetQlSyntaxTokenKind.LF_TOKEN, start, end, fullEnd, missing, unexpected, parent);
    }

    public LFToken( int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.LF, TweetQlSyntaxTokenKind.LF_TOKEN, start, end, fullStart, fullEnd, missing, unexpected, parent);
    }
}
