...
public class LessToken extends SyntaxToken {
    ...
    public LessToken(int start, int end, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.LESS, TweetQlSyntaxTokenKind.LESS_TOKEN, start, end, missing, unexpected);
    }

    public LessToken(int start, int end, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.LESS, TweetQlSyntaxTokenKind.LESS_TOKEN, start, end, fullEnd, missing, unexpected);
    }

    public LessToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.LESS, TweetQlSyntaxTokenKind.LESS_TOKEN, start, end, fullStart, fullEnd, missing, unexpected);
    }
    ...
    public LessToken(int start, int end, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.LESS, TweetQlSyntaxTokenKind.LESS_TOKEN, start, end, missing, unexpected, parent);
    }

    public LessToken(int start, int end, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.LESS, TweetQlSyntaxTokenKind.LESS_TOKEN, start, end, fullEnd, missing, unexpected, parent);
    }

    public LessToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.LESS, TweetQlSyntaxTokenKind.LESS_TOKEN, start, end, fullStart, fullEnd, missing, unexpected, parent);
    }
}
