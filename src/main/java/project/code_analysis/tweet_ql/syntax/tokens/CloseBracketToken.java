...
public class CloseBracketToken extends SyntaxToken {
    ...
    public CloseBracketToken(int start, int end, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.CLOSE_BRACKET, TweetQlSyntaxTokenKind.CLOSE_BRACKET_TOKEN, start, end, missing, unexpected);
    }

    public CloseBracketToken(int start, int end, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.CLOSE_BRACKET, TweetQlSyntaxTokenKind.CLOSE_BRACKET_TOKEN, start, end, fullEnd, missing, unexpected);
    }

    public CloseBracketToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.CLOSE_BRACKET, TweetQlSyntaxTokenKind.CLOSE_BRACKET_TOKEN, start, end, fullStart, fullEnd, missing, unexpected);
    }
    ...
    public CloseBracketToken(int start, int end, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.CLOSE_BRACKET, TweetQlSyntaxTokenKind.CLOSE_BRACKET_TOKEN, start, end, missing, unexpected, parent);
    }

    public CloseBracketToken(int start, int end, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.CLOSE_BRACKET, TweetQlSyntaxTokenKind.CLOSE_BRACKET_TOKEN, start, end, fullEnd, missing, unexpected, parent);
    }
    ...
    public CloseBracketToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.CLOSE_BRACKET, TweetQlSyntaxTokenKind.CLOSE_BRACKET_TOKEN, start, end, fullStart, fullEnd, missing, unexpected, parent);
    }
}
