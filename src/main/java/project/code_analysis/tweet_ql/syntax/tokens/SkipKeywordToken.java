...
public class SkipKeywordToken extends SyntaxToken {
    ...
    public SkipKeywordToken(int start, int end, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.SKIP_KEYWORD, TweetQlSyntaxTokenKind.SKIP_KEYWORD_TOKEN, start, end, missing, unexpected);
    }

    public SkipKeywordToken(int start, int end, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.SKIP_KEYWORD, TweetQlSyntaxTokenKind.SKIP_KEYWORD_TOKEN, start, end, fullEnd, missing, unexpected);
    }

    public SkipKeywordToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected) {
        super(TweetQlTokenString.SKIP_KEYWORD, TweetQlSyntaxTokenKind.SKIP_KEYWORD_TOKEN, start, end, fullStart, fullEnd, missing, unexpected);
    }
    ...
    public SkipKeywordToken(int start, int end, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.SKIP_KEYWORD, TweetQlSyntaxTokenKind.SKIP_KEYWORD_TOKEN, start, end, missing, unexpected, parent);
    }

    public SkipKeywordToken(int start, int end, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.SKIP_KEYWORD, TweetQlSyntaxTokenKind.SKIP_KEYWORD_TOKEN, start, end, fullEnd, missing, unexpected, parent);
    }

    public SkipKeywordToken(int start, int end, int fullStart, int fullEnd, boolean missing, boolean unexpected, SyntaxNode parent) {
        super(TweetQlTokenString.SKIP_KEYWORD, TweetQlSyntaxTokenKind.SKIP_KEYWORD_TOKEN, start, end, fullStart, fullEnd, missing, unexpected, parent);
    }
}
